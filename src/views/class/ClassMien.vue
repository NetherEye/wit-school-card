<template>
  <div class="pub">
    ...
    <el-dialog title="新建班级风采" :visible.sync="dialogDetailShow1" @close="closedShow1" width="600px" center custom-class="pwdDialog">
    ...
    <el-dialog title="新建班级风采" :visible.sync="dialogDetailShow2" @close="closed2" width="600px" center custom-class="pwdDialog">
